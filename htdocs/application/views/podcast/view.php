			...
			<div class='row'>
				...
				<div class='col-sm-3'>
					<a href='<?php echo site_url('podcast/add');?>' class='btn btn-default pull-right'><span class='glyphicon glyphicon-plus'></span> Add Tracks</a>
				</div>
			</div>
					...
					<th>Publish</th>
						...
						<tr>
							...
							<?php if($item->isPublish == 1):?>
									...
									<button class="btn btn-sm btn-success unpublish"   
